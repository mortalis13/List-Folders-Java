...
public class TumbleItem extends JApplet implements ActionListener{
  ...
  /**
   * Load the image for the specified frame of animation. Since this runs as an
   * applet, we use getResourceAsStream for efficiency and so it'll work in
  ...
  public String[][] getParameterInfo() {
    String[][] info = {
        ...
        { "speed", "int",
            "the speed at which the frames are looped; " + "default is 100" },
        { "nimgs", "int", "the number of images to be looped; default is 16" },
        { "maxwidth", "int",
            "the maximum width of any image in the loop; " + "default is 0" } };
    return info;
  }
