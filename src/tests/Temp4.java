...
public class Temp4 {
  ...
  private void initialize() {
    ...
    tfPath.setMargin(new Insets(10, 10, 2, 2));
    ...
    taFilterExt.setMargin(new Insets(10, 10, 2, 2));
    taFilterExt.setLineWrap(true);
    taFilterExt.setBorder(new LineBorder(new Color(180,180,180)));
    
    taFilterExt.setFont(new Font("Monaco", Font.PLAIN, 12));
     
    taFilterExt.setCaretPosition(0);
    
    JLabel lFilterExt = new JLabel("Filter Extensions");
    
    JTextArea taExcludeExt = new JTextArea();
    taExcludeExt.setBorder(new LineBorder(new Color(180,180,180)));
    
    JLabel lExcludeExt = new JLabel("Exclude Extensions");
    
    JTextArea taFilterDir = new JTextArea();
    taFilterDir.setBorder(new LineBorder(new Color(180,180,180)));
    ...
    taOutput.setMargin(new Insets(20, 20, 20, 20));
    taOutput.setBorder(new LineBorder(new Color(180,180,180)));
